      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link href="/contact" className="px-4 py-2 bg-teal-600 text-white rounded-full text-sm font-medium hover:bg-teal-700 transition-colors shadow-sm hover:shadow-md">
        ...
        {open && (
          <div className="md:hidden py-4 border-t border-gray-100 flex flex-col gap-3">
            ...
            <div className="pt-2 border-t border-gray-100 flex flex-col gap-3">
              ...
              <Link href="/contact" onClick={() => setOpen(false)} className="px-4 py-2 bg-teal-600 text-white rounded-full text-sm font-medium text-center hover:bg-teal-700 transition-colors">
                Schedule Consultation
              </Link>
            </div>
          </div>
