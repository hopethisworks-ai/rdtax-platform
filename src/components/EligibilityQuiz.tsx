  ...
  if (status === "success")
    return (
      <div className="text-center py-12">
        ...
        <h2 className="text-3xl font-black text-navy mb-4">You Very Likely Qualify</h2>
        ...
        <div className="bg-surface border border-primary/20 rounded-xl p-6 max-w-md mx-auto">
          <div className="text-navy font-semibold mb-2">What happens next:</div>
  ...
  if (isDisqualified && step > 1)
    return (
      <div className="text-center py-12">
        ...
        <h2 className="text-3xl font-black text-navy mb-4">You May Still Qualify</h2>
        <p className="text-body-text text-lg mb-8 max-w-lg mx-auto">
        ...
        <a
          href="/contact"
          className="bg-primary text-white font-bold px-8 py-4 rounded-xl text-lg inline-block hover:bg-primary-dark transition-colors"
        >
  ...
  if (step < questions.length) {
    ...
    return (
      <div>
        ...
        <h2 className="text-2xl font-black text-navy mb-8">{q.question}</h2>
