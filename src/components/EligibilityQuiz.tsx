    ...
    return (
      <div className="text-center py-12">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-6 max-w-md mx-auto">
          <div className="text-amber-900 font-semibold mb-2">What happens next:</div>
  ...
  if (isDisqualified && step > 1)
    return (
      <div className="text-center py-12">
        ...
        <a
          href="/contact"
          className="bg-amber-700 text-white font-bold px-8 py-4 rounded-xl text-lg inline-block hover:bg-amber-800 transition-colors"
        >
      ...
      <div>
        <div className="mb-8">
          <div className="flex justify-between items-center mb-2">
            ...
            <span className="text-sm text-amber-700 font-semibold">{progress}% complete</span>
          </div>
        ...
        <div className="space-y-3">
          {q.options.map((option) => (
            <button
              ...
              className={`w-full text-left px-6 py-4 rounded-xl border-2 font-medium transition-all hover:border-amber-600 hover:bg-amber-50 ${
                answers[q.id] === option
    ...
    <div>
      <div className="mb-8">
        <div className="flex justify-between items-center mb-2">
          ...
          <span className="text-sm text-amber-700 font-semibold">Almost done!</span>
        </div>
        <div className="w-full bg-slate-200 rounded-full h-2">
          <div className="bg-amber-700 h-2 rounded-full w-full" />
        </div>
      </div>
