  ...
  return (
    <div className="bg-white">
      ...
      <section className="py-20 px-6 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-black text-navy">What Software Activities Qualify?</h2>
            <p className="text-secondary mt-3 text-lg">Most software development qualifies — including work your team does every day</p>
          </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-4xl font-black text-navy mb-6">Real Results for SC Software Companies</h2>
            <p className="text-body-text mb-8 leading-relaxed">A Greenville-based software firm had been developing a custom platform for 3 years without ever claiming R&D credits. We identified $800,000 in qualifying developer salaries and recovered $156,000 in combined federal and SC state credits.</p>
            <div className="space-y-3">
              <div className="flex justify-between py-3 border-b border-gray-200"><span className="text-secondary text-sm">Industry</span><span className="font-bold text-navy text-sm">SaaS Software Development</span></div>
              <div className="flex justify-between py-3 border-b border-gray-200"><span className="text-secondary text-sm">Location</span><span className="font-bold text-navy text-sm">Greenville, SC</span></div>
              <div className="flex justify-between py-3 border-b border-gray-200"><span className="text-secondary text-sm">Qualifying Expenses</span><span className="font-bold text-navy text-sm">$800,000</span></div>
              <div className="flex justify-between py-3 border-b border-gray-200"><span className="text-secondary text-sm">Federal Credit</span><span className="font-bold text-navy text-sm">$116,000</span></div>
              <div className="flex justify-between py-3 border-b border-gray-200"><span className="text-secondary text-sm">SC State Credit</span><span className="font-bold text-navy text-sm">$40,000</span></div>
              <div className="flex justify-between py-3"><span className="text-navy font-bold text-sm">Total Recovered</span><span className="font-black text-primary text-xl">$156,000</span></div>
            </div>
          </div>
          <div className="space-y-4">
            <h3 className="text-2xl font-black text-navy">Frequently Asked Questions</h3>
            <details className="border border-gray-200 rounded-xl overflow-hidden">
              <summary className="px-6 py-4 font-semibold text-navy cursor-pointer hover:bg-slate-50">Does off-the-shelf software development qualify?</summary>
              <div className="px-6 pb-4 text-body-text text-sm">Internal use software can qualify if it meets specific IRS tests. Custom-developed software for clients or for sale almost always qualifies. We evaluate each project individually.</div>
            </details>
            <details className="border border-gray-200 rounded-xl overflow-hidden">
              <summary className="px-6 py-4 font-semibold text-navy cursor-pointer hover:bg-slate-50">Do developer salaries count as qualifying expenses?</summary>
              <div className="px-6 pb-4 text-body-text text-sm">Yes. Developer and engineer wages spent on qualifying R&D activities are the largest category of qualifying expenses for most software companies. Contract developer costs also qualify at 65%.</div>
            </details>
            <details className="border border-gray-200 rounded-xl overflow-hidden">
              <summary className="px-6 py-4 font-semibold text-navy cursor-pointer hover:bg-slate-50">What if we use agile or iterative development?</summary>
              <div className="px-6 pb-4 text-body-text text-sm">Agile development actually aligns well with the IRS process of experimentation test. Sprint-based development with iteration and testing is a strong indicator of qualifying R&D activity.</div>
            </details>
          </div>
        </div>
      </section>
