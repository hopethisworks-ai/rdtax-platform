      ...
      <section className="py-16 md:py-20 px-6 bg-gradient-to-br from-slate-900 via-emerald-950 to-slate-900">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h1 className="text-4xl md:text-6xl font-black text-white leading-tight mb-6">SC Manufacturers Qualify for <span className="text-emerald-400">Significant R&D Credits.</span></h1>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between py-3"><span className="text-slate-900 font-bold text-sm">Total Recovered</span><span className="font-black text-emerald-600 text-xl">$197,000</span></div>
            </div>
          </div>
