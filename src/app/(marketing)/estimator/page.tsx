      ...
      <div className="bg-white">
        <div className="py-16 md:py-20 px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-emerald-600 rounded-2xl p-10 text-center mb-6">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-8 mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/contact"
                  className="bg-emerald-600 text-white font-bold px-8 py-4 rounded-xl text-lg text-center flex-1 hover:bg-emerald-700 transition-colors"
                >
      ...
      <div className="py-16 md:py-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 mb-8 flex items-start gap-3">
            ...
            <div>
              <p className="text-emerald-800 font-semibold text-sm">SC businesses get more</p>
                ...
                <div className="sm:col-span-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full border border-slate-200 rounded-lg pl-8 pr-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-600 focus:border-transparent"
                    />
                  </div>
