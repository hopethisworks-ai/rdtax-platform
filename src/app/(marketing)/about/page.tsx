          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              <div key={card.title} className="bg-white border border-slate-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                <div className="w-10 h-10 bg-teal-50 rounded-lg flex items-center justify-center mb-3">{card.icon}</div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              <div key={step.num} className="border-l-4 border-teal-600 pl-6">
                <div className="text-teal-600 font-black text-lg mb-2">{step.num}</div>
