      ...
      <section className="py-10 px-6 bg-emerald-600">
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div>
            ...
            <div className="text-emerald-100 text-sm">Free assessment call</div>
          </div>
          <div>
            <div className="text-3xl font-black text-white mb-1">60 days</div>
            <div className="text-emerald-100 text-sm">Average to filing</div>
          </div>
          <div>
            <div className="text-3xl font-black text-white mb-1">20%</div>
            <div className="text-emerald-100 text-sm">Contingency fee only</div>
          </div>
          <div>
          ...
          {steps.map((step, i) => (
            <div key={step.number} className="flex gap-8 relative">
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 bg-emerald-600 rounded-xl flex items-center justify-center flex-shrink-0 z-10">
                  <span className="text-white font-black text-sm">{step.number}</span>
                </div>
                {i < steps.length - 1 && <div className="w-0.5 bg-emerald-100 flex-1 my-2" />}
              </div>
