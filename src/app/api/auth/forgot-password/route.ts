  ...
  try {
    ...
    if (user) {
      ...
      const emailResult = await resend.emails.send({
        from: FROM,
        to: email,
        subject: "Reset your CreditPath password",
        html: `
          <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px;">
            ...
            <p style="color:#475569;">You requested a password reset for your CreditPath account. Click the button below to set a new password.</p>
            ...
            <p style="color:#94a3b8;font-size:12px;text-align:center;">CreditPath -- South Carolina R&D Tax Credit Specialists</p>
          </div>
        `,
      });
    }
