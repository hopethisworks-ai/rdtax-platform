  ...
  try {
    ...
    try {
      await resend.emails.send({
        from: FROM,
        to: lead.email,
        subject: "Welcome to CreditPath -- Your Portal Access",
        html: `
          <div style="font-family:sans-serif;max-width:520px;margin:0 auto;padding:32px;">
            <div style="text-align:center;margin-bottom:24px;">
              <div style="display:inline-flex;align-items:center;gap:8px;">
                <div style="width:32px;height:32px;background:#2563eb;border-radius:8px;display:inline-flex;align-items:center;justify-content:center;">
                  <span style="color:white;font-weight:bold;font-size:14px;">CP</span>
                </div>
                <span style="font-weight:bold;font-size:18px;">CreditPath</span>
              </div>
            </div>
            <h2 style="color:#1e293b;text-align:center;">Welcome, ${lead.contactName}!</h2>
            <p style="color:#475569;">Your R&D tax credit engagement with CreditPath has been activated. You can now access your secure client portal to upload documents, track progress, and view your credit reports.</p>
            ...
            <p style="color:#475569;font-size:14px;">Please log in and change your password at your earliest convenience. If you have any questions, reply to this email or contact your CreditPath analyst directly.</p>
            ...
            <p style="color:#94a3b8;font-size:12px;text-align:center;">CreditPath -- South Carolina R&D Tax Credit Specialists<br/>This email contains sensitive information. Do not forward.</p>
          </div>
        `,
      });
    } catch (emailErr) {
